...
public class ModifyEdition {
    ...
    private List<Map<String,Object>> modifyEditionAttributeList = new ArrayList<>();
    ...
    public List<Map<String, Object>> getModifyEditionAttributeList() {
        return modifyEditionAttributeList;
    }

    public void setModifyEditionAttributeList(List<Map<String, Object>> modifyEditionAttributeList) {
